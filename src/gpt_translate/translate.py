...
async def _translate_file(
    ...
    if out_file.exists() and not replace and not file_is_empty(out_file):
        ...
        try:
            ...
            logging.info(f"✅ Translated file saved to [green]{out_file}[/green]", extra={"markup": True})
